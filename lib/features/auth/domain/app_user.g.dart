...
AppUser _appUserDeserialize(
  ...
  object.role = _AppUserroleValueEnumMap[reader.readStringOrNull(offsets[5])] ??
      UserRole.admin;
  return object;
}
...
extension AppUserQueryFilter
  ...
  QueryBuilder<AppUser, AppUser, QAfterFilterCondition> passwordSaltEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppUser, AppUser, QAfterFilterCondition> passwordSaltGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<AppUser, AppUser, QAfterFilterCondition> passwordSaltLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<AppUser, AppUser, QAfterFilterCondition> passwordSaltBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<AppUser, AppUser, QAfterFilterCondition> passwordSaltStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppUser, AppUser, QAfterFilterCondition> passwordSaltEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppUser, AppUser, QAfterFilterCondition> passwordSaltContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<AppUser, AppUser, QAfterFilterCondition> passwordSaltMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<AppUser, AppUser, QAfterFilterCondition> passwordSaltIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'passwordSalt',
        value: '',
...
extension AppUserQuerySortBy on QueryBuilder<AppUser, AppUser, QSortBy> {
  ...
  QueryBuilder<AppUser, AppUser, QAfterSortBy> sortByPasswordSalt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'passwordSalt', Sort.asc);
    });
  }

  QueryBuilder<AppUser, AppUser, QAfterSortBy> sortByPasswordSaltDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension AppUserQuerySortThenBy
  ...
  QueryBuilder<AppUser, AppUser, QAfterSortBy> thenByPasswordSalt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'passwordSalt', Sort.asc);
    });
  }

  QueryBuilder<AppUser, AppUser, QAfterSortBy> thenByPasswordSaltDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'passwordSalt', Sort.desc);
    });
  }
...
extension AppUserQueryWhereDistinct
  ...
  QueryBuilder<AppUser, AppUser, QDistinct> distinctByPasswordSalt(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension AppUserQueryProperty
  ...
  QueryBuilder<AppUser, String, QQueryOperations> passwordSaltProperty() {
    return QueryBuilder.apply(this, (query) {
